package com.example.mikebamb.presenter.model

object EquipmentPresenterModel {
    ...
    lateinit var presenterhours: String
    lateinit var presenterQrCode: String
    lateinit var presenterComments: String
}
